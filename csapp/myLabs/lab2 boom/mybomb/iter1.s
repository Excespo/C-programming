...
iter.o:     file format elf64-x86-64
...
00000000000010c0 <_start>:
    ...
    10e1:	48 8d 3d 04 01 00 00 	lea    0x104(%rip),%rdi        # 11ec <main>
...
00000000000011ec <main>:
    ...
    1207:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%rbp)
    120e:	bf 14 00 00 00       	mov    $0x14,%edi
    1213:	e8 88 fe ff ff       	callq  10a0 <malloc@plt>
    1218:	48 89 45 f0          	mov    %rax,-0x10(%rbp)
    121c:	48 8d 3d e1 0d 00 00 	lea    0xde1(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    1223:	e8 58 fe ff ff       	callq  1080 <puts@plt>
    1228:	48 8d 45 ec          	lea    -0x14(%rbp),%rax
    122c:	48 89 c6             	mov    %rax,%rsi
    122f:	48 8d 3d d6 0d 00 00 	lea    0xdd6(%rip),%rdi        # 200c <_IO_stdin_used+0xc>
    1236:	b8 00 00 00 00       	mov    $0x0,%eax
    123b:	e8 70 fe ff ff       	callq  10b0 <__isoc99_scanf@plt>
    1240:	8b 45 ec             	mov    -0x14(%rbp),%eax
    1243:	48 8b 55 f0          	mov    -0x10(%rbp),%rdx
    1247:	48 89 d6             	mov    %rdx,%rsi
    124a:	89 c7                	mov    %eax,%edi
    124c:	e8 58 ff ff ff       	callq  11a9 <func1>
    1251:	b8 00 00 00 00       	mov    $0x0,%eax
    1256:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    125a:	64 48 33 0c 25 28 00 	xor    %fs:0x28,%rcx
    1261:	00 00 
    1263:	74 05                	je     126a <main+0x7e>
    1265:	e8 26 fe ff ff       	callq  1090 <__stack_chk_fail@plt>
    126a:	c9                   	leaveq 
    126b:	c3                   	retq   
