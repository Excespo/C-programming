...
drafts.o:     file format elf64-x86-64
...
0000000000001040 <_start>:
    ...
    1061:	48 8d 3d 14 01 00 00 	lea    0x114(%rip),%rdi        # 117c <main>
...
0000000000001129 <var_ele>:
    1129:	f3 0f 1e fa          	endbr64 
    112d:	55                   	push   %rbp
    112e:	48 89 e5             	mov    %rsp,%rbp
    1131:	48 89 7d e8          	mov    %rdi,-0x18(%rbp)
    1135:	48 89 75 e0          	mov    %rsi,-0x20(%rbp)
    1139:	48 89 55 d8          	mov    %rdx,-0x28(%rbp)
    113d:	48 89 4d d0          	mov    %rcx,-0x30(%rbp)
    1141:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    1145:	48 8d 50 ff          	lea    -0x1(%rax),%rdx
    1149:	48 89 55 f8          	mov    %rdx,-0x8(%rbp)
    114d:	48 89 c2             	mov    %rax,%rdx
    1150:	49 89 d0             	mov    %rdx,%r8
    1153:	41 b9 00 00 00 00    	mov    $0x0,%r9d
    1159:	48 89 c2             	mov    %rax,%rdx
    115c:	48 8b 45 d8          	mov    -0x28(%rbp),%rax
    1160:	48 0f af c2          	imul   %rdx,%rax
    1164:	48 8d 14 85 00 00 00 	lea    0x0(,%rax,4),%rdx
    116b:	00 
    116c:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
    1170:	48 01 c2             	add    %rax,%rdx
    1173:	48 8b 45 d0          	mov    -0x30(%rbp),%rax
    1177:	8b 04 82             	mov    (%rdx,%rax,4),%eax
    117a:	5d                   	pop    %rbp
    117b:	c3                   	retq   
...
000000000000117c <main>:
    ...
    1184:	c7 45 f0 0a 00 00 00 	movl   $0xa,-0x10(%rbp)
    118b:	8b 55 f0             	mov    -0x10(%rbp),%edx
    118e:	89 d0                	mov    %edx,%eax
    1190:	c1 e0 03             	shl    $0x3,%eax
    1193:	29 d0                	sub    %edx,%eax
    1195:	89 45 f4             	mov    %eax,-0xc(%rbp)
    1198:	8b 45 f0             	mov    -0x10(%rbp),%eax
    119b:	69 c0 fc 03 00 00    	imul   $0x3fc,%eax,%eax
    11a1:	89 45 f8             	mov    %eax,-0x8(%rbp)
    11a4:	8b 45 f0             	mov    -0x10(%rbp),%eax
    11a7:	6b c0 7b             	imul   $0x7b,%eax,%eax
